...
- **מעבר שפה אנגלית/עברית**: לחצן שפה ליד כותרת האפליקציה מחליף את כל הממשק בין אנגלית לעברית. הפריסה נשארת מכוונת משמאל לימין (LTR) בשתי השפות, ללא מיראור RTL. הנתונים שהזנת בעצמך (שמות פרויקטים, הערות וכו') לעולם לא מתורגמים.
